...
export const metadata = {
  title: "Content authoring spec — Resumos pages | MedHelpSpace",
  description:
    "Markdown formatting and bulk-import conventions for authoring Resumos content.",
};
...
export default async function ContentAuthoringResumosDocPage() {
  const html = await getDocHtml();
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <div
        className="prose-content quiz-explanation"
        {...htmlProps(html)}
      />
    </div>
  );
