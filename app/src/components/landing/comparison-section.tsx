...
const ROWS = [
  {
    category: "Conteúdo",
    mhs: "Só temas que caem no Revalida, atualizados continuamente",
    tradicional: "Grande volume, pouco filtrado para o que o INEP cobra",
    mhsWins: true,
  },
  {
    category: "Metodologia",
    mhs: "Raciocínio clínico + pegadinhas + conduta — do jeito que a prova cobra",
    tradicional: "Aulas longas focadas em teoria, sem treino de questão real",
    mhsWins: true,
  },
  {
    category: "Formatos",
    mhs: "Questões · Resumos · Áudios · Flashcards · Fórmulas",
    tradicional: "Videoaulas longas com PDF opcional",
    mhsWins: true,
  },
  {
    category: "Mobilidade",
    mhs: "100% funciona no celular — MedVoice e Audiocards para revisar no ônibus",
    tradicional: "Videoaulas difíceis de consumir no mobile",
    mhsWins: true,
  },
  {
    category: "Atualizações",
    mhs: "Conteúdo revisado a cada edição do Revalida",
    tradicional: "Gravado uma vez, sem atualização garantida",
    mhsWins: true,
  },
  {
    category: "Fase final",
    mhs: "MedHelp 60D: revisão intensiva já inclusa — libera automático",
    tradicional: "Modulo extra pago ou inexistente",
    mhsWins: true,
  },
  {
    category: "Preço",
    mhs: "Acesso completo em uma única compra — sem mensalidade",
    tradicional: "Assinatura mensal ou preço por módulo",
    mhsWins: true,
  },
];
