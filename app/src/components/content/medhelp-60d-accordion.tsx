...
// boundary. Bodies are intentionally empty for now — content is added later.
const SECTIONS: Medhelp60Section[] = [
  { id: "revalida-up",    title: "Revalida Up",    subtitle: "Decisão Estratégica", Icon: Target },
      ...
      {SECTIONS.map((section) => {
        ...
        return (
          ...
          >
            ...
            {/* Expanded content — empty placeholder for now */}
            {isOpen && (
              <div
                style={{
