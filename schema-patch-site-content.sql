...
INSERT INTO site_content (key, value) VALUES
  ...
  ('pricing.included.3',      'Revalida Up'),
  ...
  ('faq.2.a',  'Acesso imediato ao sistema completo: Estudos por Questões, Resumos Narrativos, MedVoice, Audiocards e Revalida Up. O MedHelp 60D já está incluído na compra — liberado automaticamente 60 dias antes da prova.'),
  ...
  ('faq.6.a',  '60 dias antes da prova — revisão final guiada com MemoreCards exclusivos, Fórmula MedHelp e simulados completos (100 questões).'),
